    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private async void Timer1_Tick()
        {
            ...
            if (isConnected == true)
            {
                ...
                linearLayout_connectionStatus.SetBackgroundColor(Android.Graphics.Color.Argb(tst_serverdata.connectionStatusArgb[0], tst_serverdata.connectionStatusArgb[1], tst_serverdata.connectionStatusArgb[2], tst_serverdata.connectionStatusArgb[3]));
                contractStatus.Text = tst_serverdata.contractStatusText;
                linearLayout_contractStatus.SetBackgroundColor(Android.Graphics.Color.Argb(tst_serverdata.contractStatusArgb[0], tst_serverdata.contractStatusArgb[1], tst_serverdata.contractStatusArgb[2], tst_serverdata.contractStatusArgb[3]));
                shiftStatus.Text = tst_serverdata.shiftStatusText;
                linearLayout_shiftStatus.SetBackgroundColor(Android.Graphics.Color.Argb(tst_serverdata.shiftStatusArgb[0], tst_serverdata.shiftStatusArgb[1], tst_serverdata.shiftStatusArgb[2], tst_serverdata.shiftStatusArgb[3]));
                currentArrival_dt.Text = tst_serverdata.currentArrival_dtText;
                currentArrival_ts.Text = tst_serverdata.currentArrival_tsText;
                gridLayout_currentArrival.SetBackgroundColor(Android.Graphics.Color.Argb(tst_serverdata.currentArrivalArgb[0], tst_serverdata.currentArrivalArgb[1], tst_serverdata.currentArrivalArgb[2], tst_serverdata.currentArrivalArgb[3]));
                ...
                nextPauseTime.SetTextColor(Android.Graphics.Color.Argb(tst_serverdata.nextPauseTimeArgb[0], tst_serverdata.nextPauseTimeArgb[1], tst_serverdata.nextPauseTimeArgb[2], tst_serverdata.nextPauseTimeArgb[3]));
                remainingTime.Text = tst_serverdata.remainingTimeText;
                remainingTime.SetTextColor(Android.Graphics.Color.Argb(tst_serverdata.remainingTimeArgb[0], tst_serverdata.remainingTimeArgb[1], tst_serverdata.remainingTimeArgb[2], tst_serverdata.remainingTimeArgb[3]));
